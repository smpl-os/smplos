...
def make_nemo_css(c):
    ...
    danger    = c.get("danger", c.get("accent_alt", accent))
    rounding  = c.get("rounding", "4")
...
/* =====================================================================
 * Quick Preview window (F3 / Space preview popup)
 * ===================================================================== */
...
/* Header bar */
.nemo-quick-preview headerbar,
.nemo-quick-preview headerbar:backdrop {{
    background-color: {bg_l};
    background-image: none;
    color: {fg};
    border-bottom: 1px solid {bg_ll};
...
.nemo-quick-preview headerbar .title {{
    color: {fg};
    font-weight: bold;
}}

.nemo-quick-preview headerbar .subtitle {{
    color: {fg_dim};
    font-size: smaller;
}}

.nemo-quick-preview headerbar label {{
    color: {fg};
}}

/* Header bar buttons (prev/next nav, fullscreen, search icon, close) */
.nemo-quick-preview headerbar button,
.nemo-quick-preview headerbar button.titlebutton {{
    background-color: transparent;
    background-image: none;
    color: {fg};
    border: none;
...
.nemo-quick-preview headerbar button:hover,
.nemo-quick-preview headerbar button.titlebutton:hover {{
    background-color: {bg_ll};
    color: {fg};
}}

.nemo-quick-preview headerbar button:active,
.nemo-quick-preview headerbar button:checked {{
    background-color: {sel_bg};
    color: {sel_fg};
    box-shadow: none;
}}

.nemo-quick-preview headerbar button image,
.nemo-quick-preview headerbar button label {{
    color: inherit;
}}

/* Window decoration (shadow/rounding from WM) */
.nemo-quick-preview decoration {{
    border-radius: {rounding}px;
}}

/* Scrollbars inside the preview */
.nemo-quick-preview scrollbar {{
    background-color: {bg};
}}

.nemo-quick-preview scrollbar slider {{
    background-color: {bg_ll};
    border-radius: 4px;
    min-width: 6px;
    min-height: 6px;
...
.nemo-quick-preview scrollbar slider:hover {{
    background-color: {fg_dim};
}}

/* Dir-analyzer / label text */
.nemo-quick-preview label {{
    color: {fg};
}}
...
/* =====================================================================
 * Quick Preview in-file search bar (bottom of preview window)
 * ===================================================================== */

.nemo-quick-preview searchbar {{
    background-color: {bg_l};
    color: {fg};
    border-top: 1px solid {bg_ll};
}}

.nemo-quick-preview searchbar > revealer > box {{
    background-color: {bg_l};
}}

.nemo-quick-preview searchbar entry {{
    background-color: {bg};
    color: {fg};
...
.nemo-quick-preview searchbar entry:focus {{
    border-color: {accent};
    outline: none;
}}

.nemo-quick-preview searchbar entry selection {{
    background-color: {sel_bg};
    color: {sel_fg};
}}

/* Prev / next match buttons */
.nemo-quick-preview searchbar button {{
    background-color: transparent;
    background-image: none;
    color: {fg};
    border: none;
...
.nemo-quick-preview searchbar button:hover {{
    background-color: {bg_ll};
    color: {fg};
}}

.nemo-quick-preview searchbar button:active,
.nemo-quick-preview searchbar button:checked {{
    background-color: {sel_bg};
    color: {sel_fg};
}}

/* "No matches" status label */
.nemo-quick-preview .search-no-match {{
    color: {danger};
    font-style: italic;
}}
